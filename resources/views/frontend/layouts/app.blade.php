...
<meta name="description" content="@yield('meta_description', 'laraShop2 Boilerplate Online Shopping')">
...
<!-- header -->
    <div class="agileits_header">
        ...
        <div class="w3l_header_right1">
            <h2><a href="{{route('frontend.contactus')}}">Contact Us</a></h2>
        </div>
    ...
    <div class="logo_products">
        <div class="container">
            <div class="w3ls_logo_products_left">
                <h1><a href="{{route('frontend.index')}}">{{ app_name() }}</a></h1>
            </div>
