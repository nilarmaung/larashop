                                ...
                                <figure>
                                    <div class="snipcart-item block" >
                                        <div class="snipcart-thumb">
                                            <a href="{{route('frontend.productdetails', $hot_product->id)}}"><img title=" " alt=" " src="{{url('images/90x60/products/'.$hot_product->image)}}" /></a>      
                                            <p>{{$hot_product->title}}</p>
                                            <h4>{{$hot_product->price}} <span>$10.00</span></h4>
                                        </div>
                                        <div class="snipcart-details top_brand_home_details">
                                            <form action="#" method="post">
                                                <fieldset>
                                                    ...
                                                    <a href="{{route('frontend.addtocart', $hot_product->id)}}" class="btn btn-success">Add To Cart</a>
                                                </fieldset>
                                            </form>
                                        </div>
                                    </div>
